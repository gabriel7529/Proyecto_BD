						...
						<tbody>
							...
							<tr onclick="selectRow(this);">
								...
								<td class="actions hidden"><a
									href="Servlet4?type=info&id=<%=item.getCatProCod()%>">
										<button class="btn btn-green">Modificar</button>
								</a> <a href="Servlet4?type=delete&id=<%=item.getCatProCod()%>">
										<button class="btn btn-red">Eliminar</button>
								</a> <a href="Servlet4?type=inac&id=<%=item.getCatProCod()%>">
										<button class="btn btn-yellow">Inactivar</button>
								</a> <a href="Servlet4?type=reac&id=<%=item.getCatProCod()%>">
